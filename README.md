...
## Overview
Display and demonstration stands for the small Extreme Networks summit switches.  Included are stands for the following models:

* X435-8P-4S
* X440-G2-12P

The stands are designed to lift the front of the switches up from a desk/table to make it easier to connect cables and view the LED displays.
